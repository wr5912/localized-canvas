...
<app-context>
The name of the application is "Localized Canvas". Localized Canvas is a web application where users have a chat window and a canvas to display an artifact.
