...
Once installed, navigate to the root of the Localized Canvas repo and run `yarn dev:server` (this runs `npx @langchain/langgraph-cli dev --port 54367`).
...
After your LangGraph server is running, execute the following command to start the Localized Canvas app:
